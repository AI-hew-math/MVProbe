...
def imagenet_ids_to_class_names(labels):
    labels_dict = {}
    for id in labels:
        label = ' '.join(tiny_imagenet_id2class[id].split('_'))
...
CIFAR100_ALL_CLASSES = sorted(
    ['rabbit', 'plate', 'mountain', 'beetle', 'camel', 'lamp', 'orange', 'cockroach', 'snail', 'pear', 'streetcar', 'bicycle', 'tiger', 'porcupine', 'clock', 'train', 'cloud', 'apple', 'lion', 'crab',
     ...
     'crocodile', 'rocket', 'elephant', 'baby', 'wardrobe', 'can', 'snake', 'man', 'oak_tree', 'motorcycle', 'shrew', 'sea', 'bridge', 'skyscraper', 'raccoon', 'seal', 'sunflower', 'forest', 'bear',
     'beaver', 'maple_tree', 'couch', 'lobster', 'lizard', 'bed', 'tractor', 'woman', 'aquarium_fish', 'tank', 'mushroom', 'boy', 'dinosaur', 'fox', 'sweet_pepper', 'keyboard', 'orchid', 'road',
     'chair', 'bee', 'squirrel', 'skunk', 'possum', 'bowl', 'worm', 'television', 'kangaroo', 'trout', 'poppy', 'bus', 'butterfly', 'pine_tree', 'flatfish', 'cup', 'cattle', 'leopard', 'castle',
     'house', 'telephone', 'tulip', 'ray', 'otter', 'willow_tree', 'wolf'])

tiny_imagenet_id2class = {
    "n02119789": "kit_fox",
